...
export const PostCard = ({ post }) => {
    ...
    return (
        <div className="bg-white shadow-lag rounded-lg p-0 lg:p-8 pb-12 mg-8 mb-8">
            ...
            <h1 className="transition duration-100 text-center text-gray-700 mb-1 cursor-pointer hover:text-orange-400 text-2xl font-semibold">
            ...
            <div className="bloc text-center items-center justify-center mb-8 w-full">
                ...
                <div className="text-center">
                    <Link href={`/post/${post.slug}`}>
                        <span className="transition duration-400 transform hover:-translate-y-1 hover:bg-orange-400 inline-block bg-gray-200 text-lg font-medium rounded-full text-gray-500 hover:text-white px-8 py-2 cursor-pointer">
                            続きを読む
                        </span>
                    </Link>
                </div>
